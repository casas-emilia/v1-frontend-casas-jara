  ...
  <div class="prefabricadas-view">
    <header class="header">
      ...
      <div class="container position-relative">
        <div class="row align-items-center">
          <div class="col-md-6">
            <h1 class="display-6 fw-bold text-white animate__animated animate__fadeInLeft">Casas Prefabricadas Jara</h1>
    ...
    <div class="container-fluid bg-gradient py-5">
      ...
      <div v-if="loading" class="text-center py-5">
        <i class="fas fa-circle-notch fa-spin fa-3x text-dark"></i>
        <p class="mt-3">Cargando casas prefabricadas...</p>
      </div>

      <div v-else-if="error" class="alert alert-danger mx-3">
        <i class="fas fa-exclamation-triangle me-2 text-dark"></i>{{ error }}
      </div>

      <div v-else-if="filteredPrefabricadas.length === 0" 
           class="text-center py-5">
        <i class="fas fa-search fa-3x mb-3 text-dark"></i>
        <p class="text-dark">No se encontraron Prefabricadas con los filtros aplicados.</p>
      </div>
      ...
      >
        ...
        <div v-else class="text-dark">
          <i class="fas fa-spinner fa-spin text-dark"></i> Cargando más...
        </div>
      </div>
    </div>
  </div>
